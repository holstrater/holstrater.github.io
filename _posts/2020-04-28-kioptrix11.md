...
The first thing that came to mind when seeing a login form like this one was SQL injection. Entering "1'or'1'='1` in both fields showed this partcular form's susceptibility to SQL injection as I was given access to an application pings other machines:
